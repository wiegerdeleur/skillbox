...
class theme_skillbox_format_grid_renderer extends format_grid_renderer {
    ...
    private function make_block_topic0($course, $sections, $modinfo, $editing, $urlpicedit, $streditsummary,
        ...
        if ($this->topic0_at_top) {
            echo html_writer::start_tag('ul', array('class' => 'gtopics-0 clearfix'));
        }
        ...
        for ($section = $this->topic0_at_top ? 1 : 0; $section <= $course->numsections; $section++) {
            ...
            if ($showsection) {
                ...
                if ($course->coursedisplay != COURSE_DISPLAY_MULTIPAGE) {
					...
					echo html_writer::tag('a', $sectionname, array(
                        'href' => '#section-' . $thissection->section,
                        'id' => 'gridsection-' . $thissection->section,
                        'class' => 'gridicon_link',
                        'role' => 'link',
...
//					$thissummary = trim(clean_param($thissummary, PARAM_NOTAGS));
					...
					$title .= html_writer::tag('a', $sectionname, array(
                        'href' => $url,
                        'id' => 'gridsection-' . $thissection->section,
                        'class' => 'gridicon_link',
                        'role' => 'link',
...
class theme_skillbox_core_course_renderer extends core_course_renderer {
	/**
    ...
    public function course_section_cm($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        $output .= html_writer::start_tag('div', array('class' => 'sectionbox'));
    ...
    public function course_section_cm_text(cm_info $mod, $displayoptions = array()) {
		...
		$contentimage = strchr(strchr($content, "<img"),">",true);
        $accesstext = '';
        $textclasses = '';
        if ($mod->uservisible) {
    ...
    public function course_section_cm_list_item($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        if ($modulehtml = $this->course_section_cm($course, $completioninfo, $mod, $sectionreturn, $displayoptions)) {
            ...
            $output .= html_writer::tag('li', $modulehtml, array('class' => $modclasses.' span6', 'id' => 'module-' . $mod->id));
        }
        return $output;
    }
